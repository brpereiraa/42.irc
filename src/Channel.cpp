...
const   std::map<int, Client *> Channel::GetClients()  { return this->clients; }
const   std::map<int, Client *> Channel::GetAdmins() { return this->admins; }
const   std::map<int, Client *> Channel::GetInvited() { return this->admins; }
...
bool Channel::GetClientInChannelFD(const int fd) 
{
    for (std::map<int, Client *>::iterator it = this->clients.begin(); it != this->clients.end(); ++it) {
